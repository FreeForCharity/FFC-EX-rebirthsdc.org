...
export default function CookieConsent() {
  ...
  // this site gets GA4 delivered through GTM instead.
  ...
  const applyConsent = useCallback(
    (prefs: CookiePreferences, previousPrefs?: CookiePreferences) => {
      ...
      if (typeof window !== 'undefined') {
        ...
        // Notify any listening integrations of the change. (GTM itself now
        // loads unconditionally and is governed by Consent Mode, but the
