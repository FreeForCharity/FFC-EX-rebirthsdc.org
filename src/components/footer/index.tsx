      ...
      <div className="pr-container grid grid-cols-1 gap-8 py-14 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="space-y-3 lg:col-span-1">
          ...
          <div className="pt-1 text-sm">
            ...
            <a
              href={SITE.phoneHref}
              className="text-white hover:text-[var(--pr-flame)] transition-colors"
            >
              {SITE.phone}
            </a>
          </div>
          <div className="text-sm">
            ...
            <a
              ...
              className="text-white hover:text-[var(--pr-flame)] transition-colors break-all text-xs"
            >
              {SITE.email}
            </a>
          </div>
        ...
        <div className="space-y-3 lg:col-span-1">
          ...
          <h3 className="font-display text-base uppercase tracking-wide text-white pt-3">FAQ</h3>
          <ul className="space-y-2 text-sm">
            <li>
              <Link
                href="/mission"
                className="text-white/80 hover:text-[var(--pr-flame)] transition-colors text-xs"
              >
