  ...
  return (
    <footer className="bp-grid-dark text-white">
      ...
      <div className="border-b border-white/10 py-5">
        <div className="pr-container flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
          <p className="text-xs font-semibold uppercase tracking-widest text-white/60">
            Follow Project Rebirth
          </p>
          <div className="flex items-center gap-5">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.name}
                className="text-white/60 transition-colors hover:text-[var(--pr-flame)]"
              >
                {s.icon}
              </a>
            ))}
