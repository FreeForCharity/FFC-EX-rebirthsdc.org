...
- **GitHub Pages URL**: https://freeforcharity.github.io/FFC-EX-rebirthsdc.org/
- **Custom Domain**: https://rebirthsdc.org
...
1. **GitHub Pages subpath deployment**: `/FFC-EX-rebirthsdc.org/`
...
```yaml
env:
  NEXT_PUBLIC_BASE_PATH: /FFC-EX-rebirthsdc.org
```
...
4. **Build the site** with the correct base path:
   ...
   ```bash
   NEXT_PUBLIC_BASE_PATH=/FFC-EX-rebirthsdc.org pnpm run build
   ```
...
# Open http://localhost:3000/FFC-EX-rebirthsdc.org in your browser
```
