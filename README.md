...
- **Live Site**: [https://rebirthsdc.org](https://rebirthsdc.org)
...
- Deployed to live domain: [https://rebirthsdc.org](https://rebirthsdc.org)
...
- Keep GitHub Pages for production (rebirthsdc.org)
...
3. **Configure Build Settings**
   ...
   - Environment variables: Leave `NEXT_PUBLIC_BASE_PATH` unset
     - GitHub Pages serves at the `rebirthsdc.org` custom domain root (no basePath needed)
...
- Live at: [https://rebirthsdc.org](https://rebirthsdc.org)
- GitHub Pages URL: [https://freeforcharity.github.io/FFC-EX-rebirthsdc.org/](https://freeforcharity.github.io/FFC-EX-rebirthsdc.org/)
...
1. **Explore the live site:** [https://rebirthsdc.org](https://rebirthsdc.org)
